...
Clone this repo. Try [Github Desktop](https://desktop.github.com/) if you're not familiar with git. Or download it as a ZIP (see the green Code button at the top right of this page).
